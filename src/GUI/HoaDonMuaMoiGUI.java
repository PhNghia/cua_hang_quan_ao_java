...
public class HoaDonMuaMoiGUI extends javax.swing.JPanel {
    ...
    private HoaDonMuaGUI hdmGUI;
    private boolean wasConfirmHDM = false;

    /**
     * Creates new form HoaDonMuaMoiGUI
     */
    public HoaDonMuaMoiGUI(JDialog parentDialog, HoaDonMuaGUI hdmGUI) {
                ...
                jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jlbMaSP)
                                        .addComponent(jtfMaSP, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jlbSanPham)
                                        .addComponent(jtfSanPham, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jcbNcc, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jlbNcc)
                                        .addComponent(jbtnNccMoi))
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jlbGiaNhap)
                                        .addComponent(jtfGiaNhap, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jlbSLNhap)
                                        .addComponent(jspnSLNhap, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public void customComponents() {
        ...
        jtfMaSP.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                if (jtbCTHD.getSelectedRow() < 0) {
                    ...
                    renderDsSanPham();
                    if (hdmmBUS.getDsSanPham(wasConfirmHDM).length == 1) {
        ...
        jtfSanPham.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                if (jtbCTHD.getSelectedRow() < 0) {
                    ...
                    renderDsSanPham();
                    if (hdmmBUS.getDsSanPham(false).length == 1) {
                        jtbDSSP.setRowSelectionInterval(0, 0);
                    }
                }
            }
        ...
        jtfMaSP.addFocusListener(new FocusAdapter() {
            @Override
            public void focusLost(FocusEvent event) {
                if (jtbDSSP.getSelectedRow() != -1) {
                    autoFixValueOfSPWhenUseVNIKeyboard();
                }
            }
        });

        jtfSanPham.addFocusListener(new FocusAdapter() {
            public void focusLost(FocusEvent event) {
                if (jtbDSSP.getSelectedRow() != -1) {
                    autoFixValueOfSPWhenUseVNIKeyboard();
                }
        ...
        jbtnXacNhan.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (hdmmBUS.getDsCTHDM().length <= 0) {
                    JOptionPane.showMessageDialog(
                            parentDialog,
                            "Hóa đơn trống không thể thêm",
                ...
                if (gotOption == JOptionPane.YES_OPTION) {
                    ...
                    renderFinalGUI();
                    renderDsSanPham();
                    hdmGUI.getBUS().getDsHDMFromDB();
                    hdmGUI.renderTableHDM();
                }
            }
        });
        ...
        jbtnLamMoi.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int gotOption = JOptionPane.showConfirmDialog(
                        parentDialog,
                        "Làm mới hóa đơn sẽ xóa toàn bộ sản phẩm đã được chọn! Xác nhận làm mới?",
                        "Thông báo xác nhận",
                        JOptionPane.YES_NO_OPTION,
                        JOptionPane.INFORMATION_MESSAGE);
                if (gotOption == JOptionPane.YES_OPTION) {
        ...
        jbtnNccMoi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JDialog dialog = new JDialog(parentDialog, JDialog.DEFAULT_MODALITY_TYPE);
                dialog.setTitle("Thêm nhà cung cấp");
                dialog.setSize(352, 134);
                dialog.setLayout(new BorderLayout(0, 0));
                dialog.add(new NhaCungCapNewShortGUI(dialog, hdmmBUS));
    ...
    public void renderDsSanPham() {
        String[][] data = hdmmBUS.getDsSanPham(wasConfirmHDM);
        String[] columnsName = wasConfirmHDM ? new String[] { "Mã sản phẩm", "Sản phẩm", "Số lượng", "Đã nhập" }
                : new String[] { "Mã sản phẩm", "Sản phẩm", "Số lượng" };
        jtbDSSP.setModel(new javax.swing.table.DefaultTableModel(
                data,
                columnsName) {
            boolean[] canEdit = new boolean[] {
    ...
    public void renderGUIAction() {
        if (jtbCTHD.getSelectedRow() < 0) {
            ...
            jtfMaSP.setEnabled(true);
            jtfSanPham.setEnabled(true);
    ...
    public ChiTietHDM getInputDataFromForm() {
        ...
        // trong dữ liệu ko có item mặc định => khi kiểm tra nhận thấy người dùng đã
        // chọn ncc thì phải -1 index để get đúng vị trí của ncc
    ...
    public void handleThemSPVaoCTHDM() {
        ...
        if (jtbDSSP.getSelectedRow() != -1) {
            int existsCthdm = hdmmBUS.existsCthdm(cthdmmoi);
            if (existsCthdm != -1) {
                boolean isSame = hdmmBUS.isSameGiaNhapCuaCthdm(cthdmmoi);
                if (isSame) {
                    hdmmBUS.themCTHDM(existsCthdm, cthdmmoi);
                } else {
                    int gotOption = JOptionPane.showConfirmDialog(
                            this,
                            String.format(
                                    "Chi tiết đã tồn tại với giá nhập là %s! Xác nhận giữ giá nhập (YES) hay thay đổi giá nhập (NO). ",
                                    FormatValue.formatCurrency(hdmmBUS.getSelectedCthdm(existsCthdm).getGiaNhap())),
                            "Thông báo xác nhận",
                            JOptionPane.YES_NO_CANCEL_OPTION,
                            JOptionPane.INFORMATION_MESSAGE);
                    if (gotOption == JOptionPane.YES_OPTION) {
                        hdmmBUS.themCTHDM(existsCthdm, cthdmmoi);
                    } else if (gotOption == JOptionPane.NO_OPTION) {
                        hdmmBUS.themSuaCTHDM(existsCthdm, cthdmmoi);
                    }
                }
            } else {
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Không tìm thấy sản phẩm! Không thể thêm vào hóa đơn",
    ...
    public void autoFixValueOfSPWhenUseVNIKeyboard() {
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    Thread.sleep(2);
                    jtfMaSP.setText((String) jtbDSSP.getValueAt(jtbDSSP.getSelectedRow(), 0));
                    jtfSanPham.setText((String) jtbDSSP.getValueAt(jtbDSSP.getSelectedRow(), 1));
                    return;
